        ...
        private void OnGUI()
        {
            ...
            if (RetroInstaller.GraphsAreInstalled())
            {
                using (new EditorGUILayout.VerticalScope(pipelineBox))
                {
                    ...
                    EditorGUILayout.LabelField("<b><color=\"red\">Warning:</color></b> You may need to increase the number of shader variants via Project Settings -> Shader Graph.", infoStyle);
                }
